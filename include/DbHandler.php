     ...
     */ 
     public function createUser($name, $email, $password) {
        ...
        if (!$this->isUserExists($email)) {
            ...
            // User with this email already existed in the db
      ...
      */     
       ...
       * If the api key is there in db then it is a valid key
